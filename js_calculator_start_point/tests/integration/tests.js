...
describe('calculator functionality', function() {
  ...
  it('should update the dipslay of running total', function(){
  ...
  it('should have the output as expected for a range of numbers', function() {
    running_total = element(by.css('#running_total'))
  ...
  it('should error when dividin by zero', function() {
    running_total = element(by.css('#running_total'))
